...
function preload() {
    imagenPelota = loadImage('./img/pelota.png');
    imagenRaqueta = loadImage('./img/raqueta1.png');
    imagenComputadora = loadImage('./img/raqueta2.png');
    imagenFondo = loadImage('./img/fondo2.png');
    sonidoRaqueta = loadSound('./sound/sonido1.wav');
    sonidoGol = loadSound('./sound/sonido2.wav');
}
